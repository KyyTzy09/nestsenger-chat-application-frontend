          ...
          return (
            ...
            >
              <div
                ...
                className={`${senderId === currentUserId ? "self-end bg-blue-500 rounded-tr-none" : "self-start bg-[#303030] rounded-tl-none"} relative flex flex-col max-w-[55%] min-w-[120px] ${media ? "w-[35%]" : "w-auto"} h-auto text-white p-2 rounded-sm gap-1 shadow`}
              >
